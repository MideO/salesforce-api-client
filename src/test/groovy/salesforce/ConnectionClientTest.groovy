...
class ConnectionClientTest extends Specification {
    private HttpRequestSpecBuilder mockHttpRequestSpecBuilder = Mockito.mock(HttpRequestSpecBuilder.class);
    private RequestSpecification mockRequestSpecification = Mockito.mock(RequestSpecification.class);
    ...
    private String formData = String.format("grant_type=password&client_id=%s&client_secret=%s&username=%s&password=%s",
                                            config.clientId,
                                            config.clientSecret,
